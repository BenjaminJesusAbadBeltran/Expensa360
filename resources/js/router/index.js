    ...
    children: [
      {
        ...
        meta: { title: 'Mi perfil de Usuario', icon: 'user', noCache: true },
      },
    ],
  },
  /* {
...
export const asyncRoutes = [
  ...
  },*/
  {
    ...
    children: [
      {
        path: 'properties',
        component: () => import('@/views/table/Propiedades'),
        name: 'Propiedades',
  ...
  },
  {
    ...
    children: [
      {
        path: 'pagos',
        component: () => import('@/views/table/Pagos'),
        name: 'Pagos',
      ...
      },
      {
        ...
        meta: { title: 'Metodos de Pago', icon: 'el-icon-bank-card' },
      },
    ],
  },
  adminRoutes,
