<template>
  <div class="centered-container">
    <el-select v-model="form.selectedTable" placeholder="Select Table" @change="getColumns" style="margin-bottom: 20px;">
    ...
    <el-alert v-if="pdfGenerated" title="PDF Generated Successfully!" type="success" show-icon style="margin-top: 20px;"></el-alert>
  </div>
</template>
    ...
    getTables() {
      reporteResource.fetchTables().then(response => {
        ...
        if (Array.isArray(response) && response.length > 0) {
          ...
          console.log("Tables in Laravel:", this.tables_in_laravel);
        } else {
