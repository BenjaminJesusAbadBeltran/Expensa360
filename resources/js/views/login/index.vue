    ...
    <div class="login-container">
      ...
      <div class="login-content">
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
          ...
          <el-form-item>
            <a href="http://localhost:8000/api/auth/google/redirect" class="button">Login with Google</a>
          </el-form-item>
          <div class="tips">
...
export default {
  ...
  data() {
    const validateEmail = (rule, value, callback) => {
      if (!validEmail(value)) {
        callback(new Error('Por favor, ingrese su correo valido'));
      } else {
        callback();
      }
    };
    const validatePass = (rule, value, callback) => {
      if (value.length < 4) {
        callback(new Error('La contrasena debe ser mayor a 4 caracteres'));
      } else {
        callback();
      }
    };
